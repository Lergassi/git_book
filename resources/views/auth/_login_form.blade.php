<div class="block block_border-info">
    <div class="block__title">Вход</div>
    <div class="block__content">
        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
            ...
            <div class="input-group {{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <input id="email" type="email" class="input" name="email" value="{{ old('email') ? old('email') : "admin@site.ru" }}" required autofocus>
                @if ($errors->has('email'))
            ...
            <div class="input-group {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <input id="password" type="password" class="input" name="password" required value="qwerty">
